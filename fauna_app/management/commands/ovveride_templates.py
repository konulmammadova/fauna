...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/fauna_app/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/fauna_app/templates && cd fauna_app/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
